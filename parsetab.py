...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','pxos_dsl.py',50),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','pxos_dsl.py',54),
  ('expression -> term','expression',1,'p_expression_term','pxos_dsl.py',58),
  ('term -> term TIMES factor','term',3,'p_term_times','pxos_dsl.py',62),
  ('term -> term DIVIDE factor','term',3,'p_term_div','pxos_dsl.py',66),
  ('term -> factor','term',1,'p_term_factor','pxos_dsl.py',70),
  ('factor -> NUMBER','factor',1,'p_factor_num','pxos_dsl.py',74),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','pxos_dsl.py',78),
]
